...
final class LivreController extends AbstractController{
    ...
    //  Marque un livre comme restitué.
    #[Route('/admin/livres', name: 'livres_index', methods: ['GET'])]
    public function index1(LivreRepository $livreRepository): Response
    {
        ...
        $this->addFlash('success', 'Le livre a été marqué comme restitué.');
        }

        // Rediriger vers la liste des livres en retard
        return $this->redirectToRoute('livres_retards');
